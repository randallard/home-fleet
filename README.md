...
> Status: designed end-to-end (Phases 0–6 planned & scripted; physically standing up acer is the next step). Standing up a second home server (**acer-arch**, 1 TB) as the new
